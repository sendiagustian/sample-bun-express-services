import { ServiceError } from "../app/utils/error";
...
export class UserService {
    static async create(reqData: UserCreateRequest): Promise<string> {
        ...
        if (response !== null) {
            ...
            throw new ServiceError(400, "Bad request, failed to create data");
        }
    }
    ...
    static async updateData(uid: string, reqData: UserUpdateRequest): Promise<string> {
        ...
        if (data.affectedRows > 0) {
            ...
            throw new ServiceError(400, "Bad Request, failed to update data");
        }
    }
    ...
    static async delete(uid: string): Promise<string> {
        ...
        if (data.affectedRows > 0) {
            ...
            throw new ServiceError(400, "Bad Request, failed to delete data");
        }
    }
}
